...
const Slides = [
  ...
  },
  {
    ...
    paragraph:
      "The team at this agency took our marketing efforts to the next level. Their ability to merge creativity with data-driven insights delivered measurable results. We saw improvements in brand awareness, customer engagement, and ROI within weeks.",
  },
  {
    img: image4,
    heading: "Sophia Clark",
    paragraph:
      "I’m blown away by the level of creativity and strategic thinking this agency brings to the table. They truly understood our brand voice and created campaigns that resonated with our target audience. Our engagement rates have skyrocketed!",
  },
  {
    img: image5,
    heading: "Emily Roberts",
    paragraph:
      "Working with this marketing agency has been a game-changer for our brand. Their innovative strategies and creative approach helped us reach a wider audience than we ever imagined. The team is responsive, data-driven, and truly invested in our success.",
  },
];
...
function Testimonials() {
  ...
  return (
   ...
   sm:grid-cols-1 "
    >
      <div
        className="bg-white h-80 w-full rounded-br-full
  rounded-l-full object-center  overflow-hidden     md:ml-2 ml-0"
      >
        <img src={Slides[currentIndex].img} alt="" />
      </div>
      <div>
        <h4 className="py-6">{Slides[currentIndex].heading}</h4>
